...
function Register() {
    ...
    function validateField(name, value) {
        ...
        if (name === "username") {
            ...
            else if (len <= 4 || len >= 16) error = "Το username σας πρέπει να αποτελείται από 5 μέχρι 15 γράμματα";
            ...
            <div className={styles.registerForm}>
                <form onSubmit={handleSubmit}>
                    ...
                    <select name="provider" required onChange={handleChange} value={formData.provider}>
                        <option defaultValue="some">SOMDSO</option>
                        <option value="zeniu">ZENIU</option>
                        <option value="protergia">PROTERGIA</option>
                        <option value="other">PROTERGIA</option>
                    </select><br /><br />

                    Email<span className={styles.must}>*</span>:<br /><input type="email" name="email" value={formData.email} required onChange={handleChange} /><br /><br />
